...
// Как разделить строку на подстроки (отдельные части сторки);
// split (разделитель) - разбивает строку в массив по указанному разделителю 
// Вторым параметром можно указать ограничитель (до котрого выделяем подстроку, не включая сам ограничитель).


// // Получаем каждый символ отдельно в виде массива
...
// // Получаем каждое слово из строки раздельно
